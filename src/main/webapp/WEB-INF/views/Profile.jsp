...
<body>
  ...
  <!-- 
   ...
   -->
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Healthgoal</div>
                    <div class="col-lg-9 col-md-8">${user.health_goal}</div>
                  </div>
                   <div class="row">
                    <div class="col-lg-3 col-md-4 label">Height</div>
                    <div class="col-lg-9 col-md-8">${user.height}</div>
                  </div>
 
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">MdeicalCondition</div>
                    <div class="col-lg-9 col-md-8">${user.medicalcondition}</div>
                  </div>
