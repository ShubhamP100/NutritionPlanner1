...
<body>
 <jsp:include page ="Header.jsp"></jsp:include>
  ...
  <h4 class="mb-4 text-success">List of nutrionist</h4>
  <div class="row">
    <c:forEach var="goal" items="${nutrione}">
     
      <c:set var="r" value="${goal}" scope="request"/>
      
      <jsp:include page="../Nutrionist/NutriCard.jsp"/> <!-- ../ to import the card file  we use  -->
